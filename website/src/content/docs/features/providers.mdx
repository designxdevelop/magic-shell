...
Each provider section below lists a curated set of recent, recommended models with a cost indicator:
...
| Model | Category | Cost |
|-------|----------|------|
| `deepseek-v4-flash-free` | Fast | Free |
| `gpt-5-nano` | Fast | Free |
| `claude-haiku-4-5` | Fast | Lower-cost |
| `gemini-3.5-flash` | Fast | Lower-cost |
| `claude-sonnet-4-6` | Smart | Premium |
| `gpt-5.5` | Smart | Premium |
| `claude-opus-4-8` | Reasoning | Premium |
...
| Model | Category | Cost |
|-------|----------|------|
| `deepseek/deepseek-v4-flash` | Fast | Lower-cost |
| `z-ai/glm-5-turbo` | Fast | Lower-cost |
| `moonshotai/kimi-k2.7-code` | Smart | Lower-cost |
| `deepseek/deepseek-v4-pro` | Smart | Lower-cost |
| `anthropic/claude-sonnet-4.6` | Smart | Premium |
| `openai/gpt-5.5` | Smart | Premium |
| `anthropic/claude-opus-4.8` | Reasoning | Premium |
| `openai/gpt-5.5-pro` | Reasoning | Premium |
...
| `anthropic/claude-sonnet-4-6` | Smart | Premium |
| `anthropic/claude-opus-4-8` | Reasoning | Premium |
| `workers-ai/@cf/meta/llama-3.3-70b-instruct-fp8-fast` | Smart | Lower-cost |
...
| Model | Category | Cost |
|-------|----------|------|
| `@cf/meta/llama-3.1-8b-instruct` | Fast | Lower-cost |
| `@cf/meta/llama-3.3-70b-instruct-fp8-fast` | Smart | Lower-cost |
| `@cf/openai/gpt-oss-120b` | Reasoning | Lower-cost |
