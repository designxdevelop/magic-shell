...
## v1.1.7 - September Model Refresh

- Added open-source MiMo V2.6 Flash on OpenRouter and Vercel AI Gateway.
- Added GPT 6 Luna, GPT 6 Sol, and Claude Opus 5.5 on OpenCode Zen, OpenRouter, Vercel AI Gateway, and Cloudflare AI Gateway.
- Use effort instead of manual thinking budgets for Opus 5.5 on Zen. Because thinking is always on, the off setting uses low effort for this model.
- Kept all existing models and provider-scoped resolution unchanged.

## v1.1.6 - Development Dependencies and Trusted Publishing

- Updated Bun types, Playwright, Puppeteer, and Wrangler. Kept website TypeScript at the newest version supported by Astro Check.
- Switched automated npm releases to GitHub OIDC trusted publishing.
- Applied compatible website dependency security updates; npm audit reports no known vulnerabilities.

## v1.1.5 - September Model Catalog Update

- Added GPT 6 Astra on OpenCode Zen, OpenRouter, Vercel AI Gateway, and Cloudflare AI Gateway, including reasoning controls and compatible temperature handling.
- Added DeepSeek V4.1 Flash on OpenRouter and Vercel AI Gateway, and Nex N2.5 Mini Free on OpenRouter.
- Added Claude Fable 5.1 on OpenCode Zen, OpenRouter, Vercel AI Gateway, and Cloudflare AI Gateway.

## v1.1.4 - Expanded Open-Weight Models

**Released:** August 28, 2026

- Added the open-weight GLM 5.3 Flash model on OpenRouter, Vercel AI Gateway, and Workers AI.
- Added the main open-weight GLM 5.3 model on Workers AI.
- Added Laguna S 2.1 Free on OpenRouter, Vercel AI Gateway, and OpenCode Zen.
- Added DeepSeek V4 Flash, DeepSeek V4 Pro, and Qwen 3.8 27B on Workers AI.

## v1.1.3 - Model Catalog Update

**Released:** August 25, 2026

- Added DeepSeek V4 Pro 0813 and the open-weight Qwen 3.8 2.4T A95B model on OpenRouter and Vercel AI Gateway.
- Added Nemotron 3.5 Lightning Free on OpenRouter and OpenCode Zen.
- Added GLM 5.3 on OpenRouter and Vercel AI Gateway.
- Added Nemotron 3 Ultra Free on OpenRouter and OpenCode Zen.
- Added GLM 5.2 on Cloudflare Workers AI.
- Removed the no-longer-listed Ling 3.0 Tiny Free model from the OpenCode Zen catalog.

## v1.1.1 - Maintenance Release

**Released:** August 8, 2026

- Maintenance release for the current package distribution.

## v1.1.0 - Current Model Families

**Released:** August 5, 2026

- Added the latest GPT 5.6 and Claude 5 families across supported gateways.
- Refreshed curated open-weight models with DeepSeek V4 Flash, MiniMax M3, GLM 5.2, Qwen 3.6 27B, Kimi K3, and current free options.
- Made saved model resolution provider-scoped so shared model IDs route through the configured provider in both `msh` and `mshell`.
- Added catalog invariants and provider-resolution regression tests.
