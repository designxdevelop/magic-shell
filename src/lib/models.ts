...
export const OPENROUTER_MODELS: Model[] = [
  ...
  },
  {
    ...
    description: "High-throughput open reasoning model on OpenRouter's free tier.",
    category: "fast",
    provider: "openrouter",
    contextLength: 1000000,
    cost: "free",
  },
  {
    ...
    description: "Large open reasoning model available on OpenRouter's free tier.",
    category: "reasoning",
    provider: "openrouter",
    contextLength: 1000000,
    cost: "free",
  ...
  },
  {
    id: "z-ai/glm-5.3",
    name: "GLM 5.3",
    description: "Latest open-weight GLM model for coding, reasoning, and tool use.",
    category: "reasoning",
    provider: "openrouter",
    contextLength: 1048576,
    cost: "lower-cost",
  },
  {
    ...
    name: "GLM 5.3 Flash",
    description: "Open-weight multimodal GLM model optimized for efficient agentic coding.",
    category: "smart",
    provider: "openrouter",
  ...
  },
  {
    ...
    description: "Latest open-weight Qwen mixture-of-experts model for tools and reasoning.",
    category: "reasoning",
    provider: "openrouter",
    contextLength: 1048576,
    cost: "premium",
  },
  {
    ...
    description: "GA release of DeepSeek V4 Pro for complex agentic tasks.",
    category: "reasoning",
    provider: "openrouter",
    contextLength: 1048576,
    cost: "lower-cost",
...
export const WORKERS_AI_MODELS: Model[] = [
  {
    ...
    name: "GLM 5.3",
    description: "Open-weight flagship model for long-running agentic coding workflows.",
    category: "reasoning",
    provider: "workers-ai",
    contextLength: 1048576,
    cost: "lower-cost",
  },
  {
    ...
    name: "GLM 5.3 Flash",
    description: "Open-weight multimodal model for efficient reasoning and agentic coding.",
    category: "smart",
    provider: "workers-ai",
    contextLength: 1310720,
    cost: "lower-cost",
  },
  {
    ...
    name: "GLM 5.2",
    description: "Flagship open-weight coding model with function calling and reasoning.",
    category: "reasoning",
    provider: "workers-ai",
    contextLength: 262144,
    cost: "lower-cost",
  },
  {
    ...
    name: "DeepSeek V4 Flash 0731",
    description: "Fast open-weight DeepSeek model with a one-million-token context window.",
    category: "fast",
    provider: "workers-ai",
    contextLength: 1048576,
    cost: "lower-cost",
  },
  {
    ...
    name: "DeepSeek V4 Pro 0813",
    description: "Open-weight DeepSeek model for complex agentic work.",
    category: "reasoning",
    provider: "workers-ai",
    contextLength: 1048576,
    cost: "lower-cost",
  },
  {
    ...
    name: "Qwen 3.8 27B",
    description: "Open-weight vision-language model with reasoning and function calling.",
    category: "smart",
    provider: "workers-ai",
    contextLength: 262144,
    cost: "lower-cost",
...
export const OPENCODE_ZEN_MODELS: Model[] = [
  ...
  },
  {
    ...
    name: "Nemotron 3 Ultra (Free)",
    description: "Large open reasoning model available free on OpenCode Zen.",
    category: "reasoning",
    provider: "opencode-zen",
    zenApiType: "openai-compatible",
    contextLength: 1000000,
  ...
  },
  {
    ...
    description: "Current DeepSeek V4 reasoning model for complex agentic tasks.",
    category: "reasoning",
    provider: "opencode-zen",
    zenApiType: "openai-compatible",
    contextLength: 1048576,
