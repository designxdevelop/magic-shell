...
<Aside type="tip">
  For most shell commands, `minimax-m2.5-free` is a good default for quick experiments.
</Aside>
...
|----------|------------------|
| Quick commands | `minimax-m2.5-free` |
| Complex git operations | `claude-sonnet-4-6` |
| System administration | `ling-2.6-flash-free` or `minimax-m2.7` |
