...
Flagship models are available on multiple providers. Use this table to find the equivalent model ID on your preferred provider. Empty cells (`—`) mean the route is not included in Magic Shell's curated catalog.

| Model family | OpenCode Zen | OpenRouter | Vercel AI Gateway | Cloudflare AI Gateway | Workers AI |
|---------------|--------------|------------|-------------------|-----------------------|------------|
| GPT 6 Astra | `gpt-6-astra` | `openai/gpt-6-astra` | `openai/gpt-6-astra` | `openai/gpt-6-astra` | — |
| GPT 6 Luna | `gpt-6-luna` | `openai/gpt-6-luna` | `openai/gpt-6-luna` | `openai/gpt-6-luna` | — |
| GPT 6 Sol | `gpt-6-sol` | `openai/gpt-6-sol` | `openai/gpt-6-sol` | `openai/gpt-6-sol` | — |
| Claude Opus 5.5 | `claude-opus-5-5` | `anthropic/claude-opus-5.5` | `anthropic/claude-opus-5.5` | `anthropic/claude-opus-5-5` | — |
| DeepSeek V4.1 Flash | — | `deepseek/deepseek-v4.1-flash` | `deepseek/deepseek-v4.1-flash` | — | — |
| MiMo V2.6 Flash | — | `xiaomi/mimo-v2.6-flash` | `xiaomi/mimo-v2.6-flash` | — | — |
...
| Claude Fable 5.1 | `claude-fable-5-1` | `anthropic/claude-fable-5.1` | `anthropic/claude-fable-5.1` | `anthropic/claude-fable-5-1` | — |
...
| DeepSeek V4 Pro | `deepseek-v4-pro` | `deepseek/deepseek-v4-pro-0813` | `deepseek/deepseek-v4-pro-0813` | `deepseek/deepseek-v4-pro-0813` | — |
| GLM 5.2 | `glm-5.2` | `z-ai/glm-5.2` | — | — | — |
| GLM 5.3 | — | `z-ai/glm-5.3` | `zai/glm-5.3` | `zai/glm-5.3` | `@cf/zai-org/glm-5.3` |
| GLM 5.3 Flash | — | `z-ai/glm-5.3-flash` | `zai/glm-5.3-flash` | `zai/glm-5.3-flash` | `@cf/zai-org/glm-5.3-flash` |
| MiniMax M3 | `minimax-m3` | `minimax/minimax-m3` | — | — | — |
| Kimi K3 | `kimi-k3` | `moonshotai/kimi-k3` | — | — | — |
| Qwen 3.6 27B | — | `qwen/qwen3.6-27b` | — | — | — |
| Qwen 3.8 2.4T A95B | — | `qwen/qwen3.8-2.4t-a95b` | `alibaba/qwen3.8-2.4t-a95b` | `alibaba/qwen3.8-2.4t-a95b` | — |
...
| Laguna S 2.1 | `laguna-s-2.1-free` | `poolside/laguna-s-2.1:free` | `poolside/laguna-s-2.1-free` | `poolside/laguna-s-2.1-free` | — |
| GLM 5.2 (Workers AI) | — | — | — | — | `@cf/zai-org/glm-5.2` |
